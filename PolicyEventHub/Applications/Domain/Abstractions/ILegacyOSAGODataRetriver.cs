...
{
    public interface ILegacyOSAGODataRetriver
    {
        Task<PagedResultDto<OSAGOResponseDto>> GetFilteredCancelledCompulsoryPoliciesAsync(OSAGORequestDto request, CancellationToken cancellationToken);
